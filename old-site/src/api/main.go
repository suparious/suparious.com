...
func main() {
	...
	//endpoints
	router.HandleFunc("/api", getRolls).Methods("GET")
	router.HandleFunc("/api/{id}", getRoll).Methods("GET")
	router.HandleFunc("/api", createRoll).Methods("POST")
	router.HandleFunc("/api/{id}", updateRoll).Methods("POST")
	router.HandleFunc("/api/{id}", deleteRoll).Methods("DELETE")
