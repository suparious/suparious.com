...
namespace Oxide.Plugins
{
    ...
    class RunningMan : RustPlugin
    {
        ...
        [PluginReference]
        Plugin Clans, Economics, Friends, KarmaSystem, ServerRewards;
        ...
        void OnServerInitialized()
        {
            ...
            else if ((string) Config["Default", "AutoStart"] == "true" && (string) Config["IngameTime", "Use ingame timer"] == "true")
            {
